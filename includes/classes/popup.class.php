...
class Popup_Class {
	...
	public function include_scripts_styles() {
		wp_enqueue_style( 'simple-popup-style', SIMPLECALL_URL . 'assets/styles/popup_styles.css', array(), '0.3' );

		wp_enqueue_script( 'simple-popup-script', SIMPLECALL_URL . 'assets/scripts/popup_script.js', array( 'jquery' ), '0.3', true );
	}
}
